...
\newcommand{\figheight}{5.6005cm} % golden ratio
...
\draw[use as bounding box, white] (0,0) rectangle (\figwidth,\figheight);
 ...
 \begin{semilogxaxis}[
  ...
  \addplot+[
    ...
    \node[text width=10mm, align=center] at (axis cs: 8.82393067556, 0.035)
    {Oil in water};
    \node[text width=10mm, align=center] at (axis cs: 123.967936904, 0.035)
    {Water in oil};
