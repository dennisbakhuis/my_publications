...
\draw[
    ...
    opacity=0.5,
    thick,
] (axis cs: -3.13, 0.05) --(axis cs: -3.13, 0.00005);
...
\draw[
    ...
    opacity=0.5,
    thick,
] (axis cs: 3.13, 0.03) --(axis cs: 3.13, 0.00005);
...
\draw[
    ...
    thick,
    >=latex
    ] (axis cs: -3.13, 0.0040) -- node[above] {$\sigma$}
      (axis cs: 3.13, 0.0040);
...
\node[black, anchor=center] at (3.6cm, 1.25cm) {Retrograde};
\node[black, anchor=center] at (6.23cm, 1.25cm) {Prograde};
