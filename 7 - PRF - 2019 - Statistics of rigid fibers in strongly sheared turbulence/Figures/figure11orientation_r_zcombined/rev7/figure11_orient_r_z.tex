...
\draw[use as bounding box, white] (0,0) rectangle (\figwidth,\figheight);
 ...
 \begin{scope}[
  ...
  \begin{axis}[
    ...
    axis on top=false,
    %xlabel=$\theta_p$,
    ylabel=$\text{PDF}(\theta_p)\cdot 10^3$,
    y unit=\frac{1}{\si{\degree}},
    ylabel style={font=\footnotesize},
    width = 6.2cm,
    height = 3.7cm,
    ylabel near ticks,
    xtick={-90, -45, 0, 45, 90},
    % xticklabels={$-\pi/2$,$-\pi/4$,0,$\pi/2$,$\pi/4$}, 
...
%\addlegendentryexpanded{$0.7 < r \leq 0.9$}
 ...
 \end{scope}
 \node[black,fill=white,inner sep=0.2pt] at (1.2, 3.80) {\textbf{A}};
\end{scope}
 \begin{scope}[
     yshift=-2.5mm,
     xshift=0mm,
...
%\addlegendentryexpanded{$0.7 < r \leq 0.9$}
 ...
 \begin{scope}[
    ...
    \newcommand{\beamhe}{22.5mm}
    \newcommand{\beamhd}{17.5mm}
    \newcommand{\beamhc}{12.5mm}
    \newcommand{\beamhb}{7.5mm}
    \newcommand{\beamha}{2.5mm}
   ...
   at (\platewidth+\beamextend, \beamhe-\correct) {$\tilde{z}=0.30$};
    ...
    \draw[red, very thick, dashed] (1.52cm, 1.05cm) ellipse (0.4cm and 1cm);
    \draw[red, very thick, dashed] (1.52cm, 3.2cm) [partial ellipse=192:350:0.4cm and 1cm];

    \draw [latex-, thick] (1.225cm, 1.275cm) arc [start angle=-195, end
          angle=160, x radius=0.3cm, y radius=0.85cm];
    \draw [thick] (1.375cm, 2.425cm) arc [start angle=240, end
          angle=350, x radius=0.3cm, y radius=0.85cm];
    \draw[black, thick, -latex] (1.52cm, 3.15cm) 
            [partial ellipse=190:230:0.3cm and 0.85cm];
 \end{scope}

 \node[black,fill=white,inner sep=0.2pt] at (1.2, 1.05) {\textbf{B}};
 \end{scope}
