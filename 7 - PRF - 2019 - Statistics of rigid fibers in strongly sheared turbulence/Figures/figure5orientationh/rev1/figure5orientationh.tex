...
%\addlegendentryexpanded{$0.7 < r \leq 0.9$}
  ...
  \path (axis cs: 0,   0.0072) coordinate[rec0];  
  \path (axis cs: -45, 0.0072) coordinate[rec45];  
  \path (axis cs: 45,  0.0072) coordinate[rec45r];  
  \path (axis cs: -90, 0.0072) coordinate[rec90];  
  \path (axis cs: 90,  0.0072) coordinate[rec90];  
 ...
 \begin{scope}[
    ...
    \node[align=right, anchor=south east]
        at (\platewidth+\beamextend,\beamha) {$z=0.06$};
    ...
    \node[align=right, anchor=south east]
        at (\platewidth+\beamextend, \beamhb) {$z=0.12$};
    ...
    \node[align=right, anchor=south east]
        at (\platewidth+\beamextend, \beamhc) {$z=0.18$};
    ...
    \node[align=right, anchor=south east]
        at (\platewidth+\beamextend, \beamhd) {$z=0.24$};
   ...
   \node[align=right, anchor=south east]
        at (\platewidth+\beamextend, \beamhe) {$z=0.30$};
 ...
 \node[anchor=south west] at (0, 0.5) {$\alpha=\SI{0.05}{\percent}$};
 \node[anchor=south west] at (0, 0.02) {$\text{Re}_i=\num{8.3e4}$};
