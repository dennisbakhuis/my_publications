...
\draw[use as bounding box, white] (0,0) rectangle (\figwidth,\figheight);
  ...
  \addplot+[
    ...
    x expr = -1 * \thisrow{bins},
        ...
        y expr = \thisrow{hist},
        col sep=comma,
    ] {thetadotpdf_cw_10Hz.csv} \closedcycle;
  ...
  \addplot+[
    ...
    x expr = -1 * \thisrow{bins},
        ...
        y expr = \thisrow{hist},
        col sep=comma,
        ] {thetadotpdf_ccw_10Hz.csv} \closedcycle;
...
\draw[
    ...
    opacity=0.5,
    thick,
] (axis cs: -3.13 - 0.42, 0.04) --(axis cs: -3.13 - 0.42, 0.00005);
...
\draw[
    ...
    opacity=0.5,
    thick,
] (axis cs: 3.13 - 0.42, 0.037) --(axis cs: 3.13 - 0.42, 0.00005);
...
\draw[
    ...
    thick,
    >=latex
    ] (axis cs: -3.13 - 0.42, 0.0050) -- node[above] {$2\sigma$}
      (axis cs: 3.13 - 0.42, 0.0050);
...
% \addlegendimage{draw=red, draw opacity=0.5, densely dashed, line width=0.2mm}
% \addlegendentryexpanded{Gaussian}

  \end{semilogyaxis}

\path[draw=red, densely dotted, draw opacity=0.5, line width=0.2mm]
        (1.55cm, 3.45cm) -- (1.90cm, 3.45cm) node[black, right] {Gaussian};

%\node at (-1.0, 3.2) {(b)};
    
\newcommand\fiby{0.22cm}
\newcommand\fibx{1.82cm}
\newcommand\fibzero{4.984cm}
\newcommand\labx{0.45cm}
\newcommand\laby{1.50cm}

\node[black, anchor=east, text width=2cm, align=right] at (\fibzero - \labx, \laby)
{\SI{60}{\percent}\\ Retrograde};
\node[black, anchor=west, text width=2cm, align=left] at (\fibzero + \labx, \laby) 
{\SI{40}{\percent}\\ Prograde};
...
\begin{scope}
    ...
    \path (0.0cm, 0.0cm) coordinate[rec45];  
\end{scope}
  ...
  \begin{axis}[
    ...
    ylabel near ticks,
    xlabel near ticks,
    y tick label style={xshift=0.8mm},
    x tick label style={yshift=0.5mm},
    reverse legend,
    axis background/.style={fill=white},
    minor tick num=1,
    % xtick={-30, -20, -10, 0, 10, 20, 30},
    ytick={0, 0.1, 0.2, 0.3},
    minor ytick={0.05, 0.15, 0.25},
    % minor ytick={1e-1, 1e-3},
    %xticklabels={\ang{-10}, \ang{-5}, \ang{0}, \ang{5}, \ang{10}}
  ]
...
\draw[
    ...
    opacity=0.6,
    thin,
] (axis cs: -3.13 - 0.42, 0.15) --(axis cs: -3.13 - 0.42, 0.00005);
...
\draw[
    ...
    >=latex,
    font=\small,
    ] (axis cs: -3.13 - 10, 0.10) -- 
      (axis cs: -3.13 - 0.42, 0.10);
...
\draw[
    ...
    >=latex,
    font=\footnotesize,
    ] (axis cs: 3.13 - 0.42, 0.10) -- node[above=1.5mm, right=-2mm] {$2\sigma$}
      (axis cs: 3.13 + 10, 0.10);
